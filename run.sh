...
# 定义各目录
output_dir=~/w8/output  # 训练目录
dataset_dir=~/w8 # 数据集目录，这里是写死的，记得修改
...
do
    ...
    echo "############" END $i "evaluating, this takes a long while #################"
done

echo "#### Start Export Model ####"
# 导出模型
